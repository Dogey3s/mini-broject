...
<title>College Event Information</title>
<style>
    body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Perform SQL query
    $sql = "SELECT * FROM college_events WHERE id = $user_id";
    ...
    if ($result->num_rows > 0) {
        ...
        $stage_deco = $row['stage_deco'];
        $arr_deco = $row['arr_deco'];
        ...
        echo "<p><strong>Stage Decoration type:</strong> $stage_deco</p>";
        echo "<p><strong>Arrangement Decoration type:</strong> $arr_deco</p>";
